...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { account_id: @station.account_id, boost: @station.boost, location: @station.location }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { account_id: @station.account_id, boost: @station.boost, location: @station.location }
    assert_redirected_to station_path(assigns(:station))
  end
